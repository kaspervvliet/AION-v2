from aion_core.database.supabase_logger import upload_context, upload_bias_tracker, upload_htf_bias
"""
...
from aion_core.extensions.supabase_writer import log_signal_data
...
def execute_strategy(strategy: BaseStrategy, df, symbol: str = "SOL/USDT", tf: str = "15m") -> None:
    ...
    logger.info(f"📡 Signaal gegenereerd: {signal}")
    log_signal_data(symbol, setup=signal, rr=signal.get('rr', 0.0), reason='live_execution')
