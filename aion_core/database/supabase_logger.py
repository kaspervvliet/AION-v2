...
"""
📄 Bestand: supabase_logger.py (final version)
...
🧠 Volledige standaard REST-compliance
"""
...
def fetch_validated_signals() -> list:
    """Ophalen van gevalideerde signals uit Supabase."""
    try:
        url = f"{SUPABASE_URL}/rest/v1/signals?select=*&status=eq.validated"
        headers = {
