...
🔍 Aangepast: Structure Awareness + Volatility Adaptive Risk Management toegevoegd.
"""
...
def strategy_main(market_data, candle_history):
    ...
    if validate_entry_context(context_data):
        ...
        # 🔵 Stap 5: Entry openen met aangepaste risk
